...
def generate_launch_description():
	...
	xacro_file = get_package_share_directory('ai_path_planner_pkg') + '/description'+'/xacro/'+ robot_model +'.urdf.xacro'
	...
	spawn_entity_robot = Node(package     ='gazebo_ros', 
							  ...
							  arguments   = ['-entity', 'ai_path_planner', '-topic', 'robot_description'],
							  output      ='screen')

	# Gazebo   
	#world_file_name = 'my_empty_world.world'
	world_file_name = 'new2.world'
	#world_file_name = 'rl_world_box.world'
	world = os.path.join(get_package_share_directory('ai_path_planner_pkg'), 'worlds', world_file_name)
